(function () {
  ...
  var T = {
    uk: Object.assign({}, SHARED, {
      ...
      case19Title: "Price Watch Parser (ready demo)",
      case19P1: "<strong>Задача:</strong> показати моніторинг цін конкурентів — сторінка → parse → історія → алерт при дропі.",
      case19P2: "<strong>Зробив:</strong> FastAPI demo з HTML fixtures, знімками цін і alerts. Live на Hetzner.",
      ...
      case20Title: "WordPress + WooCommerce (ready demo)",
      case20P1: "<strong>Задача:</strong> жива вітрина WP + Woo, яку можна дати в ставці: тема, каталог, кошик, checkout без «зроблю з нуля».",
      case20P2: "<strong>Зробив:</strong> «GOORU SKIN» — бутік догляду: child theme, акції, COD, сторінки доставки/оплати. Live. Адмінка demo / DemoShop26!",
      case21Title: "OpenCart (ready demo)",
      case21P1: "<strong>Задача:</strong> окремий кейс OpenCart — показати, що ставимо й кастомізуємо магазин не лише на Woo.",
      case21P2: "<strong>Зробив:</strong> OpenCart 4.1 «GOORU AUTO» — оливи, фільтри, гальма, акції, гривня. Live. Адмінка demo / DemoShop26!",
      linkWoo: "WordPress + WooCommerce",
      linkOc: "OpenCart",
      ...
      linksNote: "Клікабельні ready demos на Hetzner — той самий стек, що в кейсах нижче.",
    ...
    en: Object.assign({}, SHARED, {
      ...
      case19Title: "Price Watch Parser (ready demo)",
      case19P1: "<strong>Problem:</strong> show competitor price monitoring — page → parse → history → drop alerts.",
      case19P2: "<strong>Built:</strong> FastAPI demo with HTML fixtures, price snapshots and alerts. Live on Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      ...
      linkAiBox: "Local AI Box",
      case20Title: "WordPress + WooCommerce (ready demo)",
      case20P1: "<strong>Problem:</strong> a live WP + Woo storefront for bids: theme, catalog, cart, checkout — not a from-scratch wait.",
      case20P2: "<strong>Built:</strong> “GOORU SKIN” skincare boutique: child theme, sale prices, COD, delivery/payment pages. Live. Admin demo / DemoShop26!",
      case21Title: "OpenCart (ready demo)",
      case21P1: "<strong>Problem:</strong> a separate OpenCart case — show we ship shops on OC, not only Woo.",
      case21P2: "<strong>Built:</strong> OpenCart 4.1 “GOORU AUTO” — oils, filters, brakes, UAH, sale SKUs. Live. Admin demo / DemoShop26!",
      linkWoo: "WordPress + WooCommerce",
      linkOc: "OpenCart",
      case13Title: "Sales Bot (ready demo)",
      ...
      linksNote: "Clickable ready demos on Hetzner — same stack as the cases below.",
    ...
    de: Object.assign({}, SHARED, {
      ...
      case19Title: "Price Watch Parser (ready demo)",
      case19P1: "<strong>Aufgabe:</strong> Preis-Monitoring — Seite → Parse → Historie → Drop-Alerts.",
      case19P2: "<strong>Gebaut:</strong> FastAPI-Demo mit HTML-Fixtures, Snapshots und Alerts. Live auf Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      ...
      linkAiBox: "Local AI Box",
      case20Title: "WordPress + WooCommerce (ready demo)",
      case20P1: "<strong>Aufgabe:</strong> ein live WP+Woo-Shop für Angebote: Theme, Katalog, Warenkorb, Checkout — nicht „bauen wir erst“.",
      case20P2: "<strong>Gebaut:</strong> „GOORU SKIN“ Pflege-Boutique: Child-Theme, Aktionen, COD, Liefer-/Zahlungsseiten. Live. Admin demo / DemoShop26!",
      case21Title: "OpenCart (ready demo)",
      case21P1: "<strong>Aufgabe:</strong> eigener OpenCart-Case — Shop nicht nur auf Woo.",
      case21P2: "<strong>Gebaut:</strong> OpenCart 4.1 „GOORU AUTO“ — Öle, Filter, Bremsen, UAH. Live. Admin demo / DemoShop26!",
      linkWoo: "WordPress + WooCommerce",
      linkOc: "OpenCart",
      case13Title: "Sales Bot (ready demo)",
      ...
      linksNote: "Klickbare Ready Demos auf Hetzner — derselbe Stack wie in den Cases.",
      linkPortfolio: "Portfolio",
      linkDemo: "Demo",
      linkTelegramBot: "Telegram bot",
      linkGithub: "GitHub",
    ...
    pl: Object.assign({}, SHARED, {
      ...
      case19Title: "Price Watch Parser (ready demo)",
      case19P1: "<strong>Problem:</strong> monitoring cen — strona → parse → historia → alerty.",
      case19P2: "<strong>Zrobilem:</strong> FastAPI demo z fixtures, snapshotami i alertami. Live na Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      ...
      linkAiBox: "Local AI Box",
      case20Title: "WordPress + WooCommerce (ready demo)",
      case20P1: "<strong>Problem:</strong> zywa witryna WP+Woo do oferty: motyw, katalog, koszyk, checkout — bez budowy od zera.",
      case20P2: "<strong>Zrobilem:</strong> „GOORU SKIN“ — butik pielegnacji: child theme, promocje, COD, dostawa/platnosc. Live. Admin demo / DemoShop26!",
      case21Title: "OpenCart (ready demo)",
      case21P1: "<strong>Problem:</strong> osobny case OpenCart — sklep nie tylko na Woo.",
      case21P2: "<strong>Zrobilem:</strong> OpenCart 4.1 „GOORU AUTO“ — oleje, filtry, hamulce, UAH. Live. Admin demo / DemoShop26!",
      linkWoo: "WordPress + WooCommerce",
      linkOc: "OpenCart",
      case13Title: "Sales Bot (ready demo)",
      ...
      linksNote: "Klikalne ready demos na Hetzner — ten sam stack co w case'ach poniżej.",
      linkPortfolio: "Portfolio",
      linkDemo: "Demo",
      linkTelegramBot: "Telegram bot",
      linkGithub: "GitHub",
    ...
    sk: Object.assign({}, SHARED, {
      ...
      case19Title: "Price Watch Parser (ready demo)",
      case19P1: "<strong>Uloha:</strong> monitoring cien — stranka → parse → historia → alerty.",
      case19P2: "<strong>Urobil som:</strong> FastAPI demo s fixtures, snapshotmi a alertami. Live na Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      ...
      linkAiBox: "Local AI Box",
      case20Title: "WordPress + WooCommerce (ready demo)",
      case20P1: "<strong>Uloha:</strong> ziva vitrina WP+Woo do ponuky: tema, katalog, kosik, checkout — nie stavba od nuly.",
      case20P2: "<strong>Urobil som:</strong> „GOORU SKIN“ — butik starostlivosti: child theme, akcie, COD, doprava/platba. Live. Admin demo / DemoShop26!",
      case21Title: "OpenCart (ready demo)",
      case21P1: "<strong>Uloha:</strong> samostatny OpenCart case — obchod nielen na Woo.",
      case21P2: "<strong>Urobil som:</strong> OpenCart 4.1 „GOORU AUTO“ — oleje, filtre, brzdy, UAH. Live. Admin demo / DemoShop26!",
      linkWoo: "WordPress + WooCommerce",
      linkOc: "OpenCart",
      case13Title: "Sales Bot (ready demo)",
      ...
      linksNote: "Klikateľné ready demá na Hetzner — rovnaký stack ako v case nižšie.",
