(function () {
  ...
  var T = {
    uk: Object.assign({}, SHARED, {
      ...
      case18P2: "<strong>Зробив:</strong> FastAPI mock-міст з REST API, імпортом XML і UI обміну. Live на Hetzner.",
      linkOnec: "1C Bridge",
      case17Title: "Telegram Mini App + Bot",
      case17P1: "<strong>Задача:</strong> клікабельне демо Mini App магазину + бот з WebApp-кнопкою для ставок FH.",
      case17P2: "<strong>Зробив:</strong> каталог → кошик → замовлення, initData/demo bypass, адмінка, HTTPS (sslip.io). Live на Hetzner.",
      linkTma: "Telegram Mini App",
      case16Title: "Marketing Mini (SMS / Viber)",
      case16P1: "<strong>Задача:</strong> клікабельне демо розсилок SMS/Viber під retail і FH — сегменти, sender, статуси доставки.",
      case16P2: "<strong>Зробив:</strong> FastAPI + SQLite + mock TurboSMS: контакти, кампанії, DLR, provider log. Live на Hetzner.",
      ...
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Задача:</strong> готове клікабельне демо під ставки FH — sales-сценарій без очікування «зроблю з нуля».",
      case13P2: "<strong>Зробив:</strong> каталог → варіант → контакт → персоналізація → замовлення + mock CRM. Web-чат і адмінка на Hetzner.",
      linkSalesBot: "AI Sales Bot",
...
case12Title: "101stomatolog — іконки фільтрів UI",
    ...
    en: Object.assign({}, SHARED, {
      ...
      case18P2: "<strong>Built:</strong> FastAPI mock bridge with REST API, XML import and exchange UI. Live on Hetzner.",
      linkOnec: "1C Bridge",
      case17Title: "Telegram Mini App + Bot",
      case17P1: "<strong>Problem:</strong> clickable Mini App shop + bot with WebApp button for freelance pitches.",
      case17P2: "<strong>Built:</strong> catalog → cart → order, initData/demo bypass, admin, HTTPS (sslip.io). Live on Hetzner.",
      linkTma: "Telegram Mini App",
      case16Title: "Marketing Mini (SMS / Viber)",
      case16P1: "<strong>Problem:</strong> clickable SMS/Viber campaign demo for retail pitches — segments, sender, delivery statuses.",
      case16P2: "<strong>Built:</strong> FastAPI + SQLite + mock TurboSMS: contacts, campaigns, DLR, provider log. Live on Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      ...
      linkAiBox: "Local AI Box",
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Problem:</strong> a clickable sales demo for freelance pitches — no build-from-scratch wait.",
      case13P2: "<strong>Built:</strong> catalog → option → contact → personalization → order + mock CRM. Web chat and admin on Hetzner.",
      linkSalesBot: "AI Sales Bot",
      linkMarketing: "Marketing Mini",
    ...
    de: Object.assign({}, SHARED, {
      ...
      case18P2: "<strong>Gebaut:</strong> FastAPI-Mock mit REST, XML-Import und Exchange-UI. Live auf Hetzner.",
      linkOnec: "1C Bridge",
      case17Title: "Telegram Mini App + Bot",
      case17P1: "<strong>Aufgabe:</strong> klickbares Mini-App-Shop-Demo + Bot mit WebApp-Button.",
      case17P2: "<strong>Gebaut:</strong> Katalog → Warenkorb → Bestellung, initData/Demo, Admin, HTTPS. Live auf Hetzner.",
      linkTma: "Telegram Mini App",
      case16Title: "Marketing Mini (SMS / Viber)",
      case16P1: "<strong>Aufgabe:</strong> klickbares SMS/Viber-Kampagnen-Demo — Segmente, Sender, Zustellstatus.",
      case16P2: "<strong>Gebaut:</strong> FastAPI + SQLite + TurboSMS-Mock: Kontakte, Kampagnen, DLR, Provider-Log. Live auf Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      ...
      linkAiBox: "Local AI Box",
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Aufgabe:</strong> klickbares Sales-Demo fuer Freelance-Pitches.",
      case13P2: "<strong>Gebaut:</strong> Katalog → Option → Kontakt → Personalisierung → Bestellung + Mock-CRM.",
      linkSalesBot: "AI Sales Bot",
      linkMarketing: "Marketing Mini",
      case12Title: "101stomatolog — Filter-Icons UI",
    ...
    pl: Object.assign({}, SHARED, {
      ...
      case18P2: "<strong>Zrobilem:</strong> FastAPI mock z REST API, importem XML i UI. Live na Hetzner.",
      linkOnec: "1C Bridge",
      case17Title: "Telegram Mini App + Bot",
      case17P1: "<strong>Problem:</strong> klikalne demo Mini App sklepu + bot z przyciskiem WebApp.",
      case17P2: "<strong>Zrobilem:</strong> katalog → koszyk → zamowienie, initData/demo, admin, HTTPS. Live na Hetzner.",
      linkTma: "Telegram Mini App",
      case16Title: "Marketing Mini (SMS / Viber)",
      case16P1: "<strong>Problem:</strong> klikalne demo kampanii SMS/Viber — segmenty, sender, statusy doreczenia.",
      case16P2: "<strong>Zrobilem:</strong> FastAPI + SQLite + mock TurboSMS: kontakty, kampanie, DLR, log providera. Live na Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      ...
      linkAiBox: "Local AI Box",
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Problem:</strong> klikalne demo sprzedazy pod oferty na freelansie.",
      case13P2: "<strong>Zrobilem:</strong> katalog → wariant → kontakt → personalizacja → zamowienie + mock CRM.",
      linkSalesBot: "AI Sales Bot",
      linkMarketing: "Marketing Mini",
    ...
    sk: Object.assign({}, SHARED, {
      ...
      case18P2: "<strong>Urobil som:</strong> FastAPI mock s REST API, XML importom a UI. Live na Hetzner.",
      linkOnec: "1C Bridge",
      case17Title: "Telegram Mini App + Bot",
      case17P1: "<strong>Uloha:</strong> klikatelne demo Mini App obchodu + bot s WebApp tlacidlom.",
      case17P2: "<strong>Urobil som:</strong> katalog → kosik → objednavka, initData/demo, admin, HTTPS. Live na Hetzner.",
      linkTma: "Telegram Mini App",
      case16Title: "Marketing Mini (SMS / Viber)",
      case16P1: "<strong>Uloha:</strong> klikatelne demo kampani SMS/Viber — segmenty, sender, stavy dorucenia.",
      case16P2: "<strong>Urobil som:</strong> FastAPI + SQLite + mock TurboSMS: kontakty, kampane, DLR, provider log. Live na Hetzner.",
      case15Title: "Telegram Bot Kit (ready demo)",
      case15P1: "<strong>Uloha:</strong> univerzalna sablona bota-ziadosti na okamiite ukazanie.",
      ...
      linkAiBox: "Local AI Box",
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Uloha:</strong> klikatelne sales demo do freelance ponuk.",
      case13P2: "<strong>Urobil som:</strong> katalog → varianta → kontakt → personalizacia → objednavka + mock CRM.",
      linkSalesBot: "AI Sales Bot",
      linkMarketing: "Marketing Mini",
