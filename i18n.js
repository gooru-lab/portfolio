(function () {
  ...
  var T = {
    uk: Object.assign({}, SHARED, {
      ...
      case11Title: "AI Lifestyle (╤З╨╛╨╗╨╛╨▓╤Ц╤З╤Ц luxury-╨╛╨▒╤А╨░╨╖╨╕)",
      case11P1: "<strong>╨Ч╨░╨┤╨░╤З╨░:</strong> ╤З╨╛╨╗╨╛╨▓╤Ц╤З╨╕╨╣ ╨┐╨╡╤А╤Б╨╛╨╜╨░╨╢ ╤Г ╨▒╤А╨╡╨╜╨┤╨╛╨▓╤Ц╨╣ ╨╡╤Б╤В╨╡╤В╨╕╤Ж╤Ц тАФ photoreal ╨║╨░╨┤╤А╨╕ ╤П╨║ ╤А╨╡╨░╨╗╤М╨╜╤Ц lifestyle-╤Д╨╛╤В╨╛.",
      case11P2: "<strong>╨Ч╤А╨╛╨▒╨╕╨▓:</strong> ╤В╨╡╤Б╤В╨╛╨▓╤Г ╤Б╨╡╤А╤Ц╤О (private jet / bar).",
      ...
      lifeLead: "╨з╨╛╨╗╨╛╨▓╤Ц╤З╨╕╨╣ ╨┐╨╡╤А╤Б╨╛╨╜╨░╨╢ ╤Г ╨▒╤А╨╡╨╜╨┤╨╛╨▓╤Ц╨╣ ╨╡╤Б╤В╨╡╤В╨╕╤Ж╤Ц: private jet, ╨▒╨░╤А, ╨░╨║╤Б╨╡╤Б╤Г╨░╤А╨╕. Photoreal ╨║╨░╨┤╤А╨╕ ╨┐╤Ц╨┤ ╨║╨░╨╝╨┐╨░╨╜╤Ц╤Ч / ╤Б╨╛╤Ж╨╝╨╡╤А╨╡╨╢╤Ц тАФ ╤П╨║ ╤А╨╡╨░╨╗╤М╨╜╤Ц ╤Д╨╛╤В╨╛.",
      lifeBack: "тЖР ╨Я╨╛╤А╤В╤Д╨╛╨╗╤Ц╨╛",
      lifeGalleryLabel: "╨в╨╡╤Б╤В╨╛╨▓╤Ц ╨┐╤А╨╕╨║╨╗╨░╨┤╨╕",
      lifeGalleryTitle: "╨з╨╛╨╗╨╛╨▓╤Ц╤З╨╕╨╣ ╨╛╨▒╤А╨░╨╖",
    ...
    en: Object.assign({}, SHARED, {
      ...
      case11P1: "<strong>Problem:</strong> a male character in brand aesthetics тАФ photoreal frames that read as real lifestyle photos.",
      ...
      lifeKicker: "AI lifestyle ┬╖ male luxury looks",
      lifeTitle: "AI Lifestyle",
      lifeLead: "Male character in brand aesthetics: private jet, bar, accessories. Photoreal frames for campaigns / social тАФ like real photos.",
      lifeBack: "тЖР Portfolio",
    ...
    de: Object.assign({}, SHARED, {
      ...
      case11Title: "AI Lifestyle (m├дnnliche Luxury-Looks)",
      case11P1: "<strong>Aufgabe:</strong> m├дnnliche Figur in Brand-├Дsthetik тАФ photoreale Frames wie echte Lifestyle-Fotos.",
      ...
      lifeKicker: "AI lifestyle ┬╖ male luxury looks",
      lifeTitle: "AI Lifestyle",
      lifeLead: "M├дnnliche Figur in Brand-├Дsthetik: Private Jet, Bar, Accessoires. Photoreale Frames f├╝r Kampagnen / Social.",
      lifeBack: "тЖР Portfolio",
      lifeGalleryLabel: "Testbeispiele",
      lifeGalleryTitle: "M├дnnlicher Look",
      lifeCap1: "Private jet ┬╖ luxury look",
      lifeCap2: "Bar ┬╖ evening look",
    ...
    pl: Object.assign({}, SHARED, {
      ...
      case11Title: "AI Lifestyle (m─Щskie luxury looki)",
      case11P1: "<strong>Problem:</strong> m─Щska posta─З w estetyce brandowej тАФ photoreal kadry jak prawdziwe zdj─Щcia lifestyle.",
      case11P2: "<strong>Zrobi┼Вem:</strong> seri─Щ testow─Е (private jet / bar).",
      linkInteriors: "AI Interiors",
      linkLifestyle: "AI Lifestyle",
      intKicker: "AI interiors · wallpaper mockups",
      intTitle: "AI Interiors",
      ...
      lifeKicker: "AI lifestyle ┬╖ male luxury looks",
      lifeTitle: "AI Lifestyle",
      lifeLead: "M─Щska posta─З w estetyce brandowej: private jet, bar, akcesoria. Photoreal kadry pod kampanie / social.",
      lifeBack: "тЖР Portfolio",
      lifeGalleryLabel: "Przyk┼Вady testowe",
      lifeGalleryTitle: "M─Щski look",
      lifeCap1: "Private jet ┬╖ luxury look",
      lifeCap2: "Bar ┬╖ evening look",
    ...
    sk: Object.assign({}, SHARED, {
      ...
      case11Title: "AI Lifestyle (mu┼╛sk├й luxury looky)",
      case11P1: "<strong>├Ъloha:</strong> mu┼╛sk├б postava v brandovej estetike тАФ photoreal z├бbery ako skuto─Нn├й lifestyle fotky.",
      case11P2: "<strong>Urobil som:</strong> testovaciu s├йriu (private jet / bar).",
      linkInteriors: "AI Interiors",
      linkLifestyle: "AI Lifestyle",
      intKicker: "AI interiors · wallpaper mockups",
      intTitle: "AI Interiors",
      ...
      lifeKicker: "AI lifestyle ┬╖ male luxury looks",
      lifeTitle: "AI Lifestyle",
      lifeLead: "Mu┼╛sk├б postava v brandovej estetike: private jet, bar, doplnky. Photoreal z├бbery pre kampane / social.",
      lifeBack: "тЖР Portf├│lio",
      lifeGalleryLabel: "Testovacie pr├нklady",
      lifeGalleryTitle: "Mu┼╛sk├╜ look",
      lifeCap1: "Private jet ┬╖ luxury look",
      lifeCap2: "Bar ┬╖ evening look",
      figGross: "Hrubý zisk",
      figSite: "Firemný web",
