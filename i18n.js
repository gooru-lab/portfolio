(function () {
  ...
  var T = {
    uk: Object.assign({}, SHARED, {
      ...
      linkBotKit: "Telegram Bot Kit",
      case15Title: "Telegram Bot Kit (ready demo)",
      case15P1: "<strong>Problem:</strong> uniwersalny szablon bota-zgłoszenia do pokazania od razu.",
      case15P2: "<strong>Zrobiłem:</strong> web-symulator + admin statusów; Telegram przez token. Live na Hetzner.",
      linkBotKit: "Telegram Bot Kit",
      case15Title: "Telegram Bot Kit (ready demo)",
      case15P1: "<strong>Úloha:</strong> univerzálna šablóna bota-žiadosti na okamžité ukázanie.",
      case15P2: "<strong>Urobil som:</strong> web simulátor + admin stavov; Telegram cez token. Live na Hetzner.",
      linkBotKit: "Telegram Bot Kit",
      ...
      linkAiBox: "Local AI Box",
      case14Title: "Local AI Box (LLM + RAG + Agent)",
      case14P1: "<strong>Problem:</strong> bezpieczne lokalne AI — odpowiedzi tylko z dokumentów.",
      case14P2: "<strong>Zrobiłem:</strong> FastAPI + Ollama + RAG/agent demo na Hetzner. Login guest / demo123.",
      linkAiBox: "Local AI Box",
      case14Title: "Local AI Box (LLM + RAG + Agent)",
      case14P1: "<strong>Úloha:</strong> bezpečné lokálne AI — odpovede len z dokumentov.",
      ...
      linkSalesBot: "AI Sales Bot",
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Aufgabe:</strong> klickbares Sales-Demo für Freelance-Pitches.",
      case13P2: "<strong>Gebaut:</strong> Katalog → Option → Kontakt → Personalisierung → Bestellung + Mock-CRM.",
      linkSalesBot: "AI Sales Bot",
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Problem:</strong> klikalne demo sprzedaży pod oferty na freelansie.",
      case13P2: "<strong>Zrobiłem:</strong> katalog → wariant → kontakt → personalizacja → zamówienie + mock CRM.",
      linkSalesBot: "AI Sales Bot",
      case13Title: "AI Sales Bot (ready demo)",
      case13P1: "<strong>Úloha:</strong> klikateľné sales demo do freelance ponúk.",
      case13P2: "<strong>Urobil som:</strong> katalóg → varianta → kontakt → personalizácia → objednávka + mock CRM.",
      linkSalesBot: "AI Sales Bot",
